...
int main() {
    ...
    CHECK_CUDA(cudaMalloc(&d_a, (size_t)max_dim * max_dim * sizeof(__nv_bfloat16)));
    CHECK_CUDA(cudaMalloc(&d_b, (size_t)max_dim * max_dim * sizeof(__nv_bfloat16)));
    CHECK_CUDA(cudaMalloc(&d_c, (size_t)max_dim * max_dim * sizeof(__nv_bfloat16)));

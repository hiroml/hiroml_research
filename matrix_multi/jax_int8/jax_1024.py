...
def main():
    ...
    mat_a = jax.random.randint(key, (size, size),minval=-128,maxval=127, dtype=jnp.int8)
    mat_b = jax.random.randint(key, (size, size),minval=-128,maxval=127, dtype=jnp.int8)
